...
export const defaultExpenseCategories: Omit<Category, 'id' | 'userId'>[] = [
  { name: 'Food', type: 'expense', color: '#ef4444', icon: 'utensils', isDefault: true, order: 1 },
  { name: 'Transport', type: 'expense', color: '#3b82f6', icon: 'car', isDefault: true, order: 2 },
  ...
  { name: 'Bills', type: 'expense', color: '#f59e0b', icon: 'zap', isDefault: true, order: 5 },
  { name: 'Health', type: 'expense', color: '#10b981', icon: 'heart-pulse', isDefault: true, order: 6 },
  { name: 'Rent', type: 'expense', color: '#06b6d4', icon: 'home', isDefault: true, order: 7 },
  ...
  { name: 'Personal', type: 'expense', color: '#d946ef', icon: 'sparkles', isDefault: true, order: 10 },
  { name: 'Other', type: 'expense', color: '#64748b', icon: 'more-horizontal', isDefault: true, order: 11 },
];
...
export const defaultIncomeCategories: Omit<Category, 'id' | 'userId'>[] = [
  ...
  { name: 'Rental', type: 'income', color: '#f59e0b', icon: 'building', isDefault: true, order: 5 },
  { name: 'Other', type: 'income', color: '#64748b', icon: 'plus-circle', isDefault: true, order: 6 },
];
